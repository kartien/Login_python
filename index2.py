...
def ventana_inicio():
    ...
    ventana_principal.geometry("400x350")  # DIMENSIONES DE LA VENTANA
...
def exito_login():
    ...
    ventana_exito.geometry("250x120")
...
def no_clave():
    ...
    ventana_no_clave.geometry("250x120")
...
def no_usuario():
    ...
    ventana_no_usuario.geometry("250x120")
...
def registro_usuario():
    ...
    Label(ventana_registro, text="Registro completado con éxito", fg="green", font=("calibri", 12)).pack()


ventana_inicio()  # Ejecucion